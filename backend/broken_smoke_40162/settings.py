"""
Django settings for broken_smoke_40162 project.
...
ROOT_URLCONF = 'broken_smoke_40162.urls'
...
WSGI_APPLICATION = 'broken_smoke_40162.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_smoke_40162 API",
    "DESCRIPTION": "API documentation for broken_smoke_40162 App",
    "VERSION": "v1",
}
